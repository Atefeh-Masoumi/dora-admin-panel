...
type EditNamespacePropsType = {};

const EditNamespaceService: FC<EditNamespacePropsType> = () => {
  const { setServerId } = useContext(EditNamespaceContext);
  const { id } = useParams();
...
export default EditNamespaceService;
