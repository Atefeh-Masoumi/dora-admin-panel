...
import { OrderTableRow } from "src/components/organisms/cloud/order/tables/OrderTableRow";
import { orderTableStruct } from "src/components/organisms/cloud/order/tables/struct";
import { useGetApiCloudOrderListQuery } from "src/app/services/api.generated";
...
const Order: FC = () => {
  const { data, refetch, isLoading } = useGetApiCloudOrderListQuery();
