...
import { invoicesTableStruct } from "src/components/organisms/cloud/invoices/tables/struct";
import { InvoicesTableRow } from "src/components/organisms/cloud/invoices/tables/InvoicesTableRow";
...
const Invoices: FC = () => {
  const { data: invoices, isLoading } = useGetApiMyCloudInvoiceListQuery();
