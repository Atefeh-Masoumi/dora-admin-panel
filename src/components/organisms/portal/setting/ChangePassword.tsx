...
import { usePostPortalPanelProfileChangePasswordMutation } from "src/app/services/api.generated";
...
export const ChangePassword: FC = () => {
  ...
  const [changePassword, { isLoading }] = usePostPortalPanelProfileChangePasswordMutation();
