...
export const WelcomeTooltip: FC = () => {
  ...
  شما در اینجا می‌توانید با معرفی دوستان و ثبت این کد، کسب درآمد کنید. برای این کار فقط کافی است که دوستان شما این کدمعرف را ثبت کنند و از هر پرداخت ۱۰ درصد کسب درآمد داشته باشید.`;
