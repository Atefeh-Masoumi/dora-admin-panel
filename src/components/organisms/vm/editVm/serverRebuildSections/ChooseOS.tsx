...
import { GetPortalVmImageListByDatacenterIdApiResponse } from "src/app/services/api.generated";
...
import { useLazyGetPortalVmImageListByDatacenterIdQuery } from "src/app/services/api";
...
export const ChooseOS: FC<ChooseOSPropsType> = ({ imageId, setImageId }) => {
  ...
  const [data, setData] =
    useState<GetPortalVmImageListByDatacenterIdApiResponse | null>(null);
