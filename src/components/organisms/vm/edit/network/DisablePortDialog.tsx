...
import {  usePutApiMyVmByProjectIdNetworkNodeDisablePortSecurityAndIdMutation } from "src/app/services/api.generated";
...
export const DisablePortDialog: FC<DialogPropsType> = ({
  ...
  const submit = () => {
    if (!id) return;
    disableport({ projectId: Number(projectId),  id })
          .unwrap()
          .then(() => {
