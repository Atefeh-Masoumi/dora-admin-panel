...
import LoadingButton from "src/components/atoms/LoadingButton";
  ...
  type VmRebuildConfirmationPropsType = DialogProps & {
  ...
  export const VmRebuildConfirmation: FC<VmRebuildConfirmationPropsType> = ({
    securityPhrase,
    onSubmit,
    submitLoading,
    ...props
    ...
    return (
      ...
      >
        <DialogTitle textAlign="center"> تاییدیه بازسازی</DialogTitle>
        <DialogContent>
          <Stack direction="column" rowGap={3}>
            <DialogContentText textAlign="center"> بازسازی سرور ابری</DialogContentText>
            <Alert variant="filled" severity="warning">
              <AlertTitle>اخطار!</AlertTitle>
              <Typography fontSize={14}>
                توجه داشته باشید  بعد از بازسازی امکان دستیابی به اطلاعات قبلی وجود ندارد!
