...
import { VmImageListResponse, useGetApiMyVmByProjectIdImageListQuery } from "src/app/services/api.generated";
...
type SelectOsPropsType = {
  ...
  setSelectedOs: (os: VmImageListResponse | null) => void;
  productId: PRODUCT_CATEGORY_ENUM;
  selectedDataCenterId?: number;
