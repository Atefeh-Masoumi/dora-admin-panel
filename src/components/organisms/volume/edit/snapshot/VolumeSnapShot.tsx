...
export const VolumeSnapshot: FC<VolumeSnapshotPropsType> = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <Stack>
          <BaseTable
            struct={volumeSnapShotTableStruct}
            RowComponent={VolumeSnapshotTableRow}
            rows={snapshotList}
