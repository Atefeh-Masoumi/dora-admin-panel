...
const radioItems = [
  {
    ...
    text: "پروتکل ارتباط بازدید‌کننده با سرورهای ابر راهبر به صورت غیر رمزنگاری شده خواهد بود.",
  },
  {
    value: 2,
    title: "ارتباط رمزنگاری شده با ابر (HTTPS-HTTP)",
    text: "پروتکل ارتباطی بازدیدکننده با سرورهای ابر راهبر به صورت TLS رمزنگاری میشود.",
  },
  {
    value: 3,
    title: "ارتباط رمزنگاری شده با ابر و از ابر با سرور اصلی (HTTPS-HTTPS)",
    text: "پروتکل ارتباطی بازدیدکننده با سرورهای ابر راهبر و از ابر راهبر با سرور اصلی به صورت TLS رمزنگاری میشود.",
  },
];
          ...
          <Stack>
            <Stack>
              ...
              <Typography variant="text15" color="secondary">
                با تنظیم این گزینه می‌توانید شیوه‌ی ارتباط بین سرورهای ابر راهبر
