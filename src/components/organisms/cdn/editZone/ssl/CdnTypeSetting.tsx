...
import { usePutPortalCdnCdnChangeCdnTypeMutation } from "src/app/services/api.generated";

const radioItems = [
  {
    value: 1,
    title: "غیر رمزنگاری شده - HTTP",
    text: "پروتکل ارتباط بازدید‌کننده با سرورهای ابر درسا به صورت غیر رمزنگاری شده خواهد بود.",
  },
  {
    value: 2,
    title: "ارتباط رمزنگاری شده با ابر (HTTPS-HTTP)",
    text: "پروتکل ارتباطی بازدیدکننده با سرورهای ابر درسا به صورت TLS رمزنگاری میشود.",
  },
  {
    value: 3,
    title: "ارتباط رمزنگاری شده با ابر و از ابر با سرور اصلی (HTTPS-HTTPS)",
    text: "پروتکل ارتباطی بازدیدکننده با سرورهای ابر درسا و از ابر درسا با سرور اصلی به صورت TLS رمزنگاری میشود.",
  },
];
