...
import { userRoleTableStruct } from "./struct";
import { DeleteUserRoleDialog } from "../dialogs/DeleteUserRoleDialog";

export const UserRoleTableRow: FC<{ row: any }> = ({ row }) => {
  ...
  return (
    <Fragment>
      <DorsaTableRow hover tabIndex={-1} key={row.value}>
        {userRoleTableStruct.map((column) => {
