...
import { addWorkspaceStepsType } from "./contexts/AddContext";
...
const steps = ["انتخاب مرکز داده", "انتخاب مشخصات سرویس", "اطلاعات سرویس"];

type AddWorkspaceStepperPropsType = {
  step: addWorkspaceStepsType;
};

export const AddWorkspaceStepper: FC<AddWorkspaceStepperPropsType> = ({
  step,
}) => {
  return (
    <Stepper
