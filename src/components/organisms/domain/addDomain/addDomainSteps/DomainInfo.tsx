...
export const DomainInfo: FC<DomainInfoPropsType> = () => {
  const { name, setName, country, setCountry, province, setProvince, city, setCity, street, setStreet, postalCode, setPostalCode,
    voice, setVoice, ns1, setNs1, ns2, setNs2, autoRenewal, setAutoRenewal, activeCdn, setActiveCdn } =
