...
import { useGetApiMyKubernetesCloudByProjectIdHostAndKuberHostIdSecretListQuery, usePostApiMyKubernetesCloudByProjectIdHostAndKuberHostIdSecretCreateMutation } from "src/app/services/api.generated";
              ...
              >
                <Grid item xs={12} mb={2}>
                  <DorsaTextField
                    ...
                    onChange={(e) =>
                      handleCertificateForTlsInformation(String(e.target.value))
                    }
                    multiline
                    rows={4}
                  />
                ...
                <Grid item xs={12} mb={2}>
                  <DorsaTextField
                    ...
                    onChange={(e) =>
                      handlePrivateKeyForTlsInformation(String(e.target.value))
                    }
                    multiline
                    rows={4}
                  />
              ...
              >
                ...
                <Grid item xs={12} mb={2}>
                  <DorsaTextField
                    ...
                    value={formik.values.envs[1]?.value || ""}
                    onChange={(e) =>
                      handlePasswordUsernameAndPassword(String(e.target.value))
                    }
                  />
                </Grid>
              </Grid>
