...
import { SelectEnvType } from "../../add/envVariable/SelectEnvType";
import { SelectEnvKey } from "../../add/envVariable/SelectEnvKey";
// import { SelectEnvValue } from "../../../add/envVariable/SelectEnvValue";
import {
...
type SelectEditEnvironmentVariablePropsType = {
  mainIndex: number;
  onDelete: () => void;
  formik: FormikProps<EditDeploymentFormType>;
};

export const SelectEditEnvironmentVariable: FC<SelectEditEnvironmentVariablePropsType> =
