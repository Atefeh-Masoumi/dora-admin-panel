...
import { AddStorageContext } from "src/components/organisms/storage/add/context/AddStorageContext";

type SelectDataCenterPropsType = {};

export const SelectDataCenter: FC<SelectDataCenterPropsType> = () => {
  const { dataCenter, setDataCenter } = useContext(AddStorageContext);
