...
import { addWorkspaceTableStruct } from "./struct";
import { AddWorkspaceContext } from "../context/AddWorkspaceContext";
...
export const AddWorkspaceTableRow: FC<{ row: any }> = ({ row }) => {
  ...
  return (
    <DorsaTableRow hover tabIndex={-1} key={row.value}>
      ...
      {addWorkspaceTableStruct
        .slice(1, addWorkspaceTableStruct.length)
        .map((column) => {
