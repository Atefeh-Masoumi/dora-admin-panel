...
import { KubeWorkspaceListResponse } from "src/app/services/api.generated";
...
type DomainCardPropsType = { item: KubeWorkspaceListResponse };
...
export const DomainCard: FC<DomainCardPropsType> = ({ item }) => {
  ...
  const settingOnClick = () => navigate("/kubernetes/" + id);
