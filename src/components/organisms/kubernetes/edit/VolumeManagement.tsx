...
import { useGetPortalKubeVolumeListByIdQuery } from "src/app/services/api.generated";
...
import { VolumeMangementTableRow } from "./volume/table/VolumeMangementTableRow";
...
export const VolumeManagement: FC<VolumeManagementPropsType> = ({ row }) => {
  ...
  const { data, isLoading, refetch } = useGetPortalKubeVolumeListByIdQuery({
    id: row,
  });
