...
import { addNamespaceStepsType } from "./context/AddNamespaceContext";
...
type AddNamespaceStepperPropsType = {
  step: addNamespaceStepsType;
};

export const AddNamespaceStepper: FC<AddNamespaceStepperPropsType> = ({
  step,
}) => {
  return (
    <Stepper
