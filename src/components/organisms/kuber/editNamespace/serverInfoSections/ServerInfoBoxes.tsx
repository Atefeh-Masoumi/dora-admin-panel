...
type ServiceInfoBoxesPropsType = {};

export const ServiceInfoBoxes: FC<ServiceInfoBoxesPropsType> = () => {
  const { id } = useParams();
    ...
    >
      ...
      >
        ...
        >
          ...
          نمایید.
          <br />
          درصورتیکه نام کاربری را فراموش کرده اید از گزینه شناسه کاربری استفاده
          نمایید.
        </Typography>
      </Stack>
      <Divider />
      ...
      <Grid2 xs={12} md={6}>
        ...
        >
          ...
          <BoxRow
            title="CPU"
            value={`${rabbitData?.createDate} Core`}
            isLoading={isLoading}
          />
          <BoxRow
            title="Memory"
            value={`${rabbitData?.createDate} G`}
            isLoading={isLoading}
          />
          <BoxRow
            title="Disk"
            value={`${rabbitData?.createDate} GB`}
            isLoading={isLoading}
          />
          <BoxRow
            title="IP Address"
