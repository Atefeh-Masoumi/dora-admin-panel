...
import { useDeletePortalKubeUserRoleDeleteByIdMutation } from "src/app/services/api.generated";
...
export const DeletePermissionDialog: FC<DeleteNamespaceDialogPropsType> = ({
  openDialog,
  handleClose,
  id,
}) => {
  const onClose = () => handleClose();
  const [deleteUserPermission, { isLoading }] =
