...
import { useDeletePortalRabbitRabbitUserDeleteByIdMutation } from "src/app/services/api.generated";
...
export const DeleteRabbitUserDialog: FC<DeleteRabbitUserDialogPropsType> = ({
  ...
  const [deleteItem, { isLoading }] = useDeletePortalRabbitRabbitUserDeleteByIdMutation();
