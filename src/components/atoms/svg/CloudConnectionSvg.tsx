...
const CloudConnectionSvg: FC<SvgIconProps & CloudConnectionProps> = ({
  mode,
  ...props
}) => {
  return (
    <SvgIcon {...props} sx={{ fill: "none", ...props.sx }}>
      ...
      <path
        d="M12 16V19"
        stroke={mode === "default" ? "#6E768A" : "#3C8AFF"}
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default CloudConnectionSvg;
