...
export const NetworkSvg: FC<SvgIconProps> = ({mode,...props}) => {
  return (
    <SvgIcon
    ...
    >
      <path
        d="M156.766,143.002h37.377v25.939h-13.97c-4.142,0-7.5,3.357-7.5,7.5s3.358,7.5,7.5,7.5h104.709c4.143,0,7.5-3.357,7.5-7.5
        ...
        fill="none"
        {...(mode === "selected" && { stroke: "#3C8AFF" })}
      />
      <path
        d="M178.233,281.115H26.709C11.981,281.115,0,293.097,0,307.824v89.556c0,14.728,11.981,26.709,26.709,26.709h37.377v25.939
      ...
      />
      <path
        d="M438.348,281.115H286.823c-14.728,0-26.709,11.981-26.709,26.709v89.556c0,14.728,11.981,26.709,26.709,26.709H324.2
      ...
      />
      <path
        d="M355.086,258.615c0,4.143,3.357,7.5,7.5,7.5s7.5-3.357,7.5-7.5v-26.087c0-4.143-3.357-7.5-7.5-7.5H240.028v-18.587
