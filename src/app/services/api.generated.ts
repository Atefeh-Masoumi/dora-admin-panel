...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    getApiMyPortalProductShortList: build.query<
      GetApiMyPortalProductShortListApiResponse,
      GetApiMyPortalProductShortListApiArg
    >({
      query: () => ({ url: `/api/my/portal/product/short-list` }),
    }),
    ...
    postApiMyVmByProjectIdVpcAndVpcHostIdNatEditSnat: build.mutation<
      PostApiMyVmByProjectIdVpcAndVpcHostIdNatEditSnatApiResponse,
      PostApiMyVmByProjectIdVpcAndVpcHostIdNatEditSnatApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/vpc/${queryArg.vpcHostId}/nat/edit-snat`,
        method: "POST",
        body: queryArg.editVpcSnatModel,
      }),
    }),
    ...
    putApiMyVmByProjectIdNetworkNodeEnableFirewallAndId: build.mutation<
      PutApiMyVmByProjectIdNetworkNodeEnableFirewallAndIdApiResponse,
      PutApiMyVmByProjectIdNetworkNodeEnableFirewallAndIdApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/network/node/enable-firewall/${queryArg.id}`,
        method: "PUT",
        body: queryArg.enableFirewallNetworkNodeModel,
      }),
    }),
    ...
    putApiMyVmByProjectIdNetworkNodeDisableFirewallAndId: build.mutation<
      PutApiMyVmByProjectIdNetworkNodeDisableFirewallAndIdApiResponse,
      PutApiMyVmByProjectIdNetworkNodeDisableFirewallAndIdApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/network/node/disable-firewall/${queryArg.id}`,
        method: "PUT",
      }),
    }),
    ...
    postApiMyVmByProjectIdVmIsoNodeUnmount: build.mutation<
      PostApiMyVmByProjectIdVmIsoNodeUnmountApiResponse,
      PostApiMyVmByProjectIdVmIsoNodeUnmountApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/vm/iso/node/unmount`,
        method: "POST",
        body: queryArg.vmIsoNodeUnmountModel,
      }),
    }),
    postApiMyVmByProjectIdVmIsoNodeMount: build.mutation<
      PostApiMyVmByProjectIdVmIsoNodeMountApiResponse,
      PostApiMyVmByProjectIdVmIsoNodeMountApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/vm/iso/node/mount`,
        method: "POST",
        body: queryArg.vmIsoNodeMountModel,
      }),
    }),
    getApiMyVmByProjectIdVmIsoNodeList: build.query<
      GetApiMyVmByProjectIdVmIsoNodeListApiResponse,
      GetApiMyVmByProjectIdVmIsoNodeListApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/vm/iso/node/list`,
        params: {
          VmIsoId: queryArg.vmIsoId,
          VmHostId: queryArg.vmHostId,
        },
      }),
    }),
    getApiMyVmByProjectIdIsoShortList: build.query<
      GetApiMyVmByProjectIdIsoShortListApiResponse,
      GetApiMyVmByProjectIdIsoShortListApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/iso/short-list`,
      }),
    }),
    ...
    putApiMyVmByProjectIdHostIpEnableFirewallAndId: build.mutation<
      PutApiMyVmByProjectIdHostIpEnableFirewallAndIdApiResponse,
      PutApiMyVmByProjectIdHostIpEnableFirewallAndIdApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/host/ip/enable-firewall/${queryArg.id}`,
        method: "PUT",
        body: queryArg.enableFirewallVmIpModel,
      }),
    }),
    ...
    putApiMyVmByProjectIdHostIpDisableFirewallAndId: build.mutation<
      PutApiMyVmByProjectIdHostIpDisableFirewallAndIdApiResponse,
      PutApiMyVmByProjectIdHostIpDisableFirewallAndIdApiArg
    >({
      query: (queryArg) => ({
        url: `/api/my/vm/${queryArg.projectId}/host/ip/disable-firewall/${queryArg.id}`,
        method: "PUT",
      }),
    }),
...
export type GetApiMyPortalProductShortListApiResponse =
  /** status 200 OK */ ProductShortListResponse[];
export type GetApiMyPortalProductShortListApiArg = void;
...
export type PostApiMyVmByProjectIdVpcAndVpcHostIdNatEditSnatApiResponse =
  unknown;
export type PostApiMyVmByProjectIdVpcAndVpcHostIdNatEditSnatApiArg = {
  projectId: number;
  vpcHostId: number;
  editVpcSnatModel: EditVpcSnatModel;
};
...
export type PutApiMyVmByProjectIdNetworkNodeEnableFirewallAndIdApiResponse =
  unknown;
export type PutApiMyVmByProjectIdNetworkNodeEnableFirewallAndIdApiArg = {
  projectId: number;
  id: number;
  enableFirewallNetworkNodeModel: EnableFirewallNetworkNodeModel;
};
...
export type PutApiMyVmByProjectIdNetworkNodeDisableFirewallAndIdApiResponse =
  unknown;
export type PutApiMyVmByProjectIdNetworkNodeDisableFirewallAndIdApiArg = {
  projectId: number;
  id: number;
};
...
export type PostApiMyVmByProjectIdVmIsoNodeUnmountApiResponse = unknown;
export type PostApiMyVmByProjectIdVmIsoNodeUnmountApiArg = {
  projectId: number;
  vmIsoNodeUnmountModel: VmIsoNodeUnmountModel;
};
export type PostApiMyVmByProjectIdVmIsoNodeMountApiResponse = unknown;
export type PostApiMyVmByProjectIdVmIsoNodeMountApiArg = {
  projectId: number;
  vmIsoNodeMountModel: VmIsoNodeMountModel;
};
export type GetApiMyVmByProjectIdVmIsoNodeListApiResponse =
  /** status 200 OK */ VmIsoNodeListResponse[];
export type GetApiMyVmByProjectIdVmIsoNodeListApiArg = {
  vmIsoId?: number;
  vmHostId?: number;
  projectId: number;
};
export type GetApiMyVmByProjectIdIsoShortListApiResponse =
  /** status 200 OK */ VmIsoShortListResponse[];
export type GetApiMyVmByProjectIdIsoShortListApiArg = {
  projectId: number;
};
...
export type PutApiMyVmByProjectIdHostIpEnableFirewallAndIdApiResponse = unknown;
export type PutApiMyVmByProjectIdHostIpEnableFirewallAndIdApiArg = {
  projectId: number;
  id: number;
  enableFirewallVmIpModel: EnableFirewallVmIpModel;
};
...
export type PutApiMyVmByProjectIdHostIpDisableFirewallAndIdApiResponse =
  unknown;
export type PutApiMyVmByProjectIdHostIpDisableFirewallAndIdApiArg = {
  projectId: number;
  id: number;
};
...
export type ProductShortListResponse = {
  id: number;
  name: string | null;
};
...
export type IssueItemListResponse = {
  ...
  createDate: string;
  modifyDate?: string | null;
  issueItems?: IssueItemResponse[] | null;
};
...
export type CreateVolumeHostModel = {
  name?: string | null;
  isPredefined?: boolean;
  volumeAutoBackup?: boolean;
  volumeAutoSnapshot?: boolean;
  calculateTypeId?: number | null;
  productBundleId?: number | null;
...
export type VmNetworkNodeListResponse = {
  ...
  status: string | null;
  statusId: number;
  enabledFirewall: boolean;
  firwallName?: string | null;
  createDate?: string;
};
export type EnableFirewallNetworkNodeModel = {
  vmFirewallId?: number;
};
...
export type VmIsoNodeUnmountModel = {
  vmIsoNodeId?: number;
  vmHostId?: number;
};
export type VmIsoNodeMountModel = {
  vmIsoId?: number;
  vmHostId?: number;
};
export type VmIsoNodeListResponse = {
  id?: number;
  statusId?: number;
  status: string | null;
  vmIso: string | null;
...
export type VmIsoShortListResponse = {
  id?: number;
  name: string | null;
  description?: string | null;
};
...
export type EnableFirewallVmIpModel = {
  vmFirewallId?: number;
};
...
export const {
  ...
  useGetApiMyPortalProductShortListQuery,
  ...
  usePostApiMyVmByProjectIdVpcAndVpcHostIdNatEditSnatMutation,
  ...
  usePutApiMyVmByProjectIdNetworkNodeEnableFirewallAndIdMutation,
  usePutApiMyVmByProjectIdNetworkNodeDisablePortSecurityAndIdMutation,
  usePutApiMyVmByProjectIdNetworkNodeDisableFirewallAndIdMutation,
  ...
  usePostApiMyVmByProjectIdVmIsoNodeUnmountMutation,
  usePostApiMyVmByProjectIdVmIsoNodeMountMutation,
  ...
  usePutApiMyVmByProjectIdHostIpEnableFirewallAndIdMutation,
  usePutApiMyVmByProjectIdHostAndVmHostIdIpDisablePortSecurityIdMutation,
  usePutApiMyVmByProjectIdHostIpDisableFirewallAndIdMutation,
