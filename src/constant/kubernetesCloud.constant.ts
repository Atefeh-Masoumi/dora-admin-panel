...
export const appImageList = [
  ...
  { id: 7, name: "grafana", src: "/assets/icons/grafana.svg" },
  { id: 8, name: "redis", src: "/assets/icons/redis.svg" },
  { id: 9, name: "kibana", src: "/assets/icons/kibana.svg" },
  { id: 10, name: "minio", src: "/assets/icons/minio.svg" },
  { id: 11, name: "kafka", src: "/assets/icons/kafka.svg" },
  { id: 12, name: "postgres", src: "/assets/icons/postgres.svg" },
  { id: 13, name: "rabbitmq", src: "/assets/icons/rabbitmq.svg" },
];
